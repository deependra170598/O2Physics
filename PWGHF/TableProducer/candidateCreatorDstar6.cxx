...
//   using Hf2ProngsWStatus = soa:: Join<aod::Hf2Prongs, aod::HfCutStatus2Prong>;
  ...
  DECLARE_SOA_TABLE(HfCandDStarBase,"AOD","HFDSTARCAND",
    ...
    DECLARE_SOA_TABLE(HfD0ProngofDStar,"AOD","D0PRONGOFDSTAR",
                                o2::soa::Index<>,
        ...
        DECLARE_SOA_EXTENDED_TABLE_USER(HfCand2ProngExtDStar, HfD0ProngofDStar, "HFCAND2PEXT", //!
...
struct HfCandidateCreatorDstar{
  ...
  Produces<aod::HfD0ProngofDStar> D0CandTable;
