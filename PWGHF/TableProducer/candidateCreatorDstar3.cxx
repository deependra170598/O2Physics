...
struct HfCandidateCreatorDstar {
  ...
  void process(aod::Collisions const& cols, SelectedPionTrack const& tracks, SelectedD0 const& d0Table)
  {
    ...
    // =========================================================================================================================
    Partition<SelectedPionTrack> SoftTrack_0 = (aod::track::pt > static_cast<float>(ConfCuts->get(uint(0), "min_pT_soft_pi"))) && (aod::track::pt <= static_cast<float>(ConfCuts->get(uint(0), "max_pT_soft_pi")));
    SoftTrack_0.bindTable(tracks);

    Partition<SelectedD0> SelectedD0_0 = Prong0pT > static_cast<float>(ConfCuts->get(uint(0), "min_pT_prong0")) && Prong1pT > static_cast<float>(ConfCuts->get(uint(0), "min_pT_prong1"));
    SelectedD0_0.bindTable(d0Table);
    // =========================================================================================================================
    Partition<SelectedPionTrack> SoftTrack_1 = (aod::track::pt > static_cast<float>(ConfCuts->get(uint(1), "min_pT_soft_pi"))) && (aod::track::pt <= static_cast<float>(ConfCuts->get(uint(1), "max_pT_soft_pi")));
    SoftTrack_1.bindTable(tracks);

    Partition<SelectedD0> SelectedD0_1 = Prong0pT > static_cast<float>(ConfCuts->get(uint(1), "min_pT_prong0")) && Prong1pT > static_cast<float>(ConfCuts->get(uint(1), "min_pT_prong1"));
    SelectedD0_1.bindTable(d0Table);
    // =========================================================================================================================
    Partition<SelectedPionTrack> SoftTrack_2 = (aod::track::pt > static_cast<float>(ConfCuts->get(uint(2), "min_pT_soft_pi"))) && (aod::track::pt <= static_cast<float>(ConfCuts->get(uint(2), "max_pT_soft_pi")));
    SoftTrack_2.bindTable(tracks);

    Partition<SelectedD0> SelectedD0_2 = Prong0pT > static_cast<float>(ConfCuts->get(uint(2), "min_pT_prong0")) && Prong1pT > static_cast<float>(ConfCuts->get(uint(2), "min_pT_prong1"));
    SelectedD0_2.bindTable(d0Table);
    // =========================================================================================================================
    Partition<SelectedPionTrack> SoftTrack_3 = (aod::track::pt > static_cast<float>(ConfCuts->get(uint(3), "min_pT_soft_pi"))) && (aod::track::pt <= static_cast<float>(ConfCuts->get(uint(3), "max_pT_soft_pi")));
    SoftTrack_3.bindTable(tracks);

    Partition<SelectedD0> SelectedD0_3 = Prong0pT > static_cast<float>(ConfCuts->get(uint(3), "min_pT_prong0")) && Prong1pT > static_cast<float>(ConfCuts->get(uint(3), "min_pT_prong1"));
    SelectedD0_3.bindTable(d0Table);
    // =========================================================================================================================
    Partition<SelectedPionTrack> SoftTrack_4 = (aod::track::pt > static_cast<float>(ConfCuts->get(uint(4), "min_pT_soft_pi"))) && (aod::track::pt <= static_cast<float>(ConfCuts->get(uint(4), "max_pT_soft_pi")));
    SoftTrack_4.bindTable(tracks);

    Partition<SelectedD0> SelectedD0_4 = Prong0pT > static_cast<float>(ConfCuts->get(uint(4), "min_pT_prong0")) && Prong1pT > static_cast<float>(ConfCuts->get(uint(4), "min_pT_prong1"));
    SelectedD0_4.bindTable(d0Table);
    // =========================================================================================================================
    Partition<SelectedPionTrack> SoftTrack_5 = (aod::track::pt > static_cast<float>(ConfCuts->get(uint(5), "min_pT_soft_pi"))) && (aod::track::pt <= static_cast<float>(ConfCuts->get(uint(5), "max_pT_soft_pi")));
    SoftTrack_5.bindTable(tracks);

    Partition<SelectedD0> SelectedD0_5 = Prong0pT > static_cast<float>(ConfCuts->get(uint(5), "min_pT_prong0")) && Prong1pT > static_cast<float>(ConfCuts->get(uint(5), "min_pT_prong1"));
    SelectedD0_5.bindTable(d0Table);
    // =========================================================================================================================
    Partition<SelectedPionTrack> SoftTrack_6 = (aod::track::pt > static_cast<float>(ConfCuts->get(uint(6), "min_pT_soft_pi"))) && (aod::track::pt <= static_cast<float>(ConfCuts->get(uint(6), "max_pT_soft_pi")));
    SoftTrack_6.bindTable(tracks);

    Partition<SelectedD0> SelectedD0_6 = Prong0pT > static_cast<float>(ConfCuts->get(uint(6), "min_pT_prong0")) && Prong1pT > static_cast<float>(ConfCuts->get(uint(6), "min_pT_prong1"));
    SelectedD0_6.bindTable(d0Table);
    // =========================================================================================================================
    Partition<SelectedPionTrack> SoftTrack_7 = (aod::track::pt > static_cast<float>(ConfCuts->get(uint(7), "min_pT_soft_pi"))) && (aod::track::pt <= static_cast<float>(ConfCuts->get(uint(7), "max_pT_soft_pi")));
    SoftTrack_7.bindTable(tracks);

    Partition<SelectedD0> SelectedD0_7 = Prong0pT > static_cast<float>(ConfCuts->get(uint(7), "min_pT_prong0")) && Prong1pT > static_cast<float>(ConfCuts->get(uint(7), "min_pT_prong1"));
    SelectedD0_7.bindTable(d0Table);
    // =========================================================================================================================
    Partition<SelectedPionTrack> SoftTrack_8 = (aod::track::pt > static_cast<float>(ConfCuts->get(uint(8), "min_pT_soft_pi"))) && (aod::track::pt <= static_cast<float>(ConfCuts->get(uint(8), "max_pT_soft_pi")));
    SoftTrack_8.bindTable(tracks);

    Partition<SelectedD0> SelectedD0_8 = Prong0pT > static_cast<float>(ConfCuts->get(uint(8), "min_pT_prong0")) && Prong1pT > static_cast<float>(ConfCuts->get(uint(8), "min_pT_prong1"));
    SelectedD0_8.bindTable(d0Table);
    // =========================================================================================================================
    Partition<SelectedPionTrack> SoftTrack_9 = (aod::track::pt > static_cast<float>(ConfCuts->get(uint(9), "min_pT_soft_pi"))) && (aod::track::pt <= static_cast<float>(ConfCuts->get(uint(9), "max_pT_soft_pi")));
    SoftTrack_9.bindTable(tracks);

    Partition<SelectedD0> SelectedD0_9 = Prong0pT > static_cast<float>(ConfCuts->get(uint(9), "min_pT_prong0")) && Prong1pT > static_cast<float>(ConfCuts->get(uint(9), "min_pT_prong1"));
    SelectedD0_9.bindTable(d0Table);
    // =========================================================================================================================
    Partition<SelectedPionTrack> SoftTrack_10 = (aod::track::pt > static_cast<float>(ConfCuts->get(uint(10), "min_pT_soft_pi"))) && (aod::track::pt <= static_cast<float>(ConfCuts->get(uint(10), "max_pT_soft_pi")));
    SoftTrack_10.bindTable(tracks);

    Partition<SelectedD0> SelectedD0_10 = Prong0pT > static_cast<float>(ConfCuts->get(uint(10), "min_pT_prong0")) && Prong1pT > static_cast<float>(ConfCuts->get(uint(10), "min_pT_prong1"));
    ...
    for (auto& col : cols) {
      ...
      std::vector<o2::soa::Filtered<SelectedD0>> Vector_D0_Partition{
        D0_0,
        D0_1,
        D0_2,
        D0_3,
      ...
      for (int i = 0; i < nBinsPt; i++) {
        for (auto& [t, d0] : combinations(CombinationsFullIndexPolicy(Vector_SoftPi_Partition[i], Vector_D0_Partition[i]))) {
          // safe gaurd
          if ((t.collisionId() != d0.collisionId()) && (t.collisionId() != col.globalIndex()))
            continue;
          if (t.globalIndex() == d0.prong0Id() || t.globalIndex() == d0.prong1Id())
            continue;
