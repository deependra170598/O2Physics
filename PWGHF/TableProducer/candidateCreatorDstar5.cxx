// NewcandidateCreatorDstar7.cxx <----> candidateCreatorDstar5.cxx
// When I was using O2DatabasePDG: program was crashing. 
// Retest after solving debug problem in hf-track-index-skim-creator

/* Here DECLARE_SOA_TABLE_VERSIONED(HfCand2ProngBase_001,"AOD","HFCAND2PBASE",1, ...columns.....); is used.
Not successfully build. reason: redinition of structure (Table)
next I will try o2::soa::Marker<1> 
*/
...
//   using Hf2ProngsWStatus = soa:: Join<aod::Hf2Prongs, aod::HfCutStatus2Prong>;
  ...
  DECLARE_SOA_TABLE(HfCandDStarBase,"AOD","HFDSTARCAND",
    ...
    DECLARE_SOA_TABLE_VERSIONED(HfCand2ProngBase_001,"AOD","HFCAND2PBASE",1,
                                o2::soa::Index<>,
        ...
        DECLARE_SOA_EXTENDED_TABLE_USER(HfCand2ProngExtDStar, HfCand2ProngBase_001, "HFCAND2PEXT", //!
...
struct HfCandidateCreatorDstar{
  ...
  Produces<aod::HfCand2ProngBase_001> D0CandTable;
